...
var BinlogStatsGroups = []map[string]string{
...
var CmdStatsGroups = []map[string]string{
...
var CurrentStatsGroups = []map[string]string{
...
var OtherStatsGroups = []map[string]string{
...
var TubeStatFields = []map[string]string{
